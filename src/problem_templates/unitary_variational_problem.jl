...
- `ddu_bounds=fill(ddu_bound, system.n_drives)`: Bounds for each second derivative of the control variable.
...
- `R_u::Union{Float64, Vector{Float64}}=R`: Regularization weights for control.
- `R_du::Union{Float64, Vector{Float64}}=R`: Regularization weights for control derivative.
- `R_ddu::Union{Float64, Vector{Float64}}=R`: Regularization weights for control second derivative.
